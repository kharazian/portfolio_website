...
namespace AKH.Portfolio.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PortfolioDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PortfolioEfCoreEntityExtensionMappings to extend the IdentityUser entity
