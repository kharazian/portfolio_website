...
namespace AKH.Portfolio.ObjectExtending
{
    public static class PortfolioDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the PortfolioEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
